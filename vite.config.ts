...
export default defineConfig(({ mode }) => ({
      ...
      output: {
        manualChunks: (id) => {
          ...
          if (id.includes('node_modules')) {
            ...
            // PDF libraries (pdf-lib + html2pdf.js + dependencies)
            if (id.includes('node_modules/pdf-lib') || id.includes('node_modules/pdfjs-dist') || id.includes('node_modules/html2pdf.js') || id.includes('node_modules/html2canvas') || id.includes('node_modules/jspdf')) {
              return 'pdf-vendor';
            }
  ...
  optimizeDeps: {
    include: ['html2pdf.js'], // Pre-bundle for dynamic import support
  },
  server: {
    port: 3000,
    open: true,
