...
// Admin-only endpoint for fetching employees and admins
// Returns profiles with role IN ('employee','admin')
...
module.exports = async function handler(req, res) {
  const requestId = `employees_${Date.now()}_${Math.random().toString(16).slice(2)}`;
